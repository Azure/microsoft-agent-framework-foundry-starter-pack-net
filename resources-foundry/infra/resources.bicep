...
// resource localCognitiveServicesOpenAIUserRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
//   scope: foundry
//   name: guid(foundry.id, foundryproject.id, cognitiveServicesOpenAIUserRole.id, principalId)
//   properties: {
//     principalId: principalId
...
// resource cloudCognitiveServicesOpenAIUserRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
//   scope: foundry
//   name: guid(foundry.id, foundryproject.id, cognitiveServicesOpenAIUserRole.id, foundryproject.name)
//   properties: {
//     principalId: foundryproject.identity.principalId
//     roleDefinitionId: cognitiveServicesOpenAIUserRole.id
//     principalType: 'ServicePrincipal'
